...
public class ByMovieMapperTest {
	...
	public void testNormal() {
		long[] result = new long[] { 1000L, 5L, 1400000000L };
		try {
			driver	// userId: 1000, movieId: 200, rating: 5, timestamp: 1400000000
					...
					.withOutput(new LongWritable(200), new LongArrayWritable(result))
					.runTest();
		} catch (IOException e) {
			fail();
		}
